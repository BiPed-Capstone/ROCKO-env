...
#ifndef ROCKO_ENV__ADD_FEEDFORWARD_CONTROLLER_HPP_
#define ROCKO_ENV__ADD_FEEDFORWARD_CONTROLLER_HPP_
...
#include <rocko_env/add_feedforward_controller_parameters.hpp>
...
class AddFeedforwardController : public controller_interface::ChainableControllerInterface
{
public:
...
protected:
  ...
  std::shared_ptr<add_feedforward_controller::ParamListener> param_listener_;
  add_feedforward_controller::Params params_;
...
#endif  // ROCKO_ENV__ADD_FEEDFORWARD_CONTROLLER_HPP_
